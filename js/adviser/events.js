window.SharedNavigation.ready.then((context) => {
  ...
  function openActionMenu(trigger, event) {
    ...
    actionMenu.innerHTML = event.is_archived
      ...
      : `<a class="${itemClass}" href="pages/adviser/event-details.html?id=${event.id}" role="menuitem">View details</a><a class="${itemClass}" href="pages/adviser/event-details.html?id=${event.id}#event-activities" role="menuitem">Manage activities</a><a class="${itemClass}" href="pages/adviser/score-configuration.html?event_id=${event.id}" role="menuitem">Score activities</a><a class="${itemClass}" href="pages/adviser/event-edit.html?id=${event.id}" role="menuitem">Edit event</a><div class="my-1 border-t border-[#121017]/8"></div><button class="${destructiveClass}" type="button" data-menu-action="archive" role="menuitem">Archive event</button>`;
