...
final class AdviserAttendanceScanRepository {
    ...
    public function index(array $filters):array {
        ...
        $fields="ae.id,ae.recorded_by officer_id,ae.scanned_at,ae.status,ae.session_code,ae.phase,ae.scan_latitude,ae.scan_longitude,
            ...
            ae.venue_name_snapshot,e.id event_id,e.location_id,e.title event_name,l.latitude venue_latitude,l.longitude venue_longitude,l.radius venue_radius,s.schedule_date,s.id schedule_id,
    ...
    private function hydrate(array &$rows):void {
        foreach($rows as &$row){
            $row['id']=(int)$row['id'];$row['officer_id']=$row['officer_id']===null?null:(int)$row['officer_id'];$row['event_id']=(int)$row['event_id'];$row['location_id']=$row['location_id']===null?null:(int)$row['location_id'];$row['day_number']=(int)$row['day_number'];$row['schedule_id']=(int)$row['schedule_id'];
