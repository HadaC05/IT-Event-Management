...
@section('content')
    ...
    <header class="mb-8"><p class="mb-2 text-xs font-extrabold uppercase tracking-[.14em] text-emerald-700">New Tribe</p><h1 class="text-3xl font-extrabold tracking-tight text-[#141e46] sm:text-4xl">Create a Tribe</h1><p class="mt-2 text-sm text-slate-500">Set up the tribe identity and choose its student members.</p></header>
